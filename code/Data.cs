...
static class Data
{
    ...
    {
        Api = new("http://localhost:8000", "API_KEY", "dummy/Kr64"),
        Bluetooth = new("BLUETOOTH_NAME")
    });
    ...
    import_tables_external_api - import the tables from the provided external api
    Api json structure:
    {JsonSerializer.Serialize(NewTable.Data.Api, Utils.JsonOptions)}
    """);
